...
public class EstoqueController {
    ...
    public ResponseEntity<List<ItemEstoque>> consultarEstoque(
        ...
        // Idealmente, retornar um DTO aqui também, mas mantendo ItemEstoque por simplicidade inicial
        List<ItemEstoque> itens = estoqueService.consultarEstoque(jogoId, plataformaId, depositoId);
